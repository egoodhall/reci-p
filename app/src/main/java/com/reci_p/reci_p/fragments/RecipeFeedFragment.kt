 ...
 * [RecipeFeedFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [RecipeFeedFragment.newInstance] factory method to
...
class RecipeFeedFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): RecipeFeedFragment {
